...
The Free version of *WPf2b* is configured by defining constants in ``wp-config.php``. If you're using the Premium version, or you know your way around ``wp-config.php`` already, skip ahead to :ref:`configuration__logging`.
