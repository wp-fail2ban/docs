...
The Premium flavour of *WP fail2ban* can be downloaded from Freemius and installed as a zip file, or installed via Composer. Details for installation using Composer can be found on the `Members page <https://wp-fail2ban.com/members/#!/login>`_.
